...
val samplePlants = listOf(
    PlantModel(
        ...
        uses = listOf(
            RemedyModel(
                "Trị bệnh cảm lạnh", ingredients = listOf(
                    "Bạc hà 1,5 g", "Bạch đồng nữ 2 g", "Diệp cam thảo 3g"
                )
            ),
            RemedyModel("Hỗ trợ điều trị bệnh tiểu đường"),
            RemedyModel("Kháng viêm"),
            RemedyModel("Giảm đau dạ dày và chứng khó tiêu"),
            RemedyModel("Làm sạch và giảm hôi miệng"),
            RemedyModel("Giảm căng thẳng, cải thiện sức khỏe tâm thần"),
            RemedyModel("Hỗ trợ ngăn ngừa bệnh tim mạch"),
            RemedyModel("Chống nhiễm trùng, giúp vết thương nhanh lành"),
        ),
    ...
    PlantModel(
        "Hoắc hương", "Hoắc hương là vị thuốc quý được dùng nhiều trong Đông y",
        arrayListOf(
            "", "", ""
        ).map { RemedyModel(it) },
    ),
